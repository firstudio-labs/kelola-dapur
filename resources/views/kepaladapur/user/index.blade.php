@extends('template_kepala_dapur.layout') @section('content')
    ...
    <div class="card">
        ...
        >
            ...
            <small class="text-muted">
                ...
                <strong>{{ $users->total() }}</strong> dari "{{
                    request("search")
                }}" @else Total: <strong>{{ $users->total() }}</strong> user
                @endif
            </small>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    ...
                                    >{{ ucfirst(str_replace('_', ' ', $user->userRole->role_type)) }}</span
                                >
                            </td>
                            <td class="text-center">
                                <span
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-4">
                                <div class="text-muted">
                                    @if(request('search'))
                                    <p>
                                        Tidak ditemukan hasil untuk "<strong>{{
                                            request("search")
                                        }}</strong
                                        >"
                                    </p>
        ...
        <div class="card-footer">
            <small class="text-muted">
                ...
                @if(request('search')) untuk pencarian "{{ request("search") }}"
                @endif
            </small>
        </div>
        @endif
