    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form action="{{ route('kepala-dapur.users.update', ['dapur' => $dapur, 'user' => $user]) }}" method="POST"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role_type" id="role_type" required
                                    ...
                                    @foreach ($roles as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('role_type', $user->userRole->role_type) == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('role_type')
                    ...
                    <div class="col-12" id="admin_gudang_section"
                        style="display: {{ old('role_type', $user->userRole->role_type) === 'admin_gudang' ? 'block' : 'none' }};">
                        <hr class="my-3">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jabatan" id="jabatan_admin"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kontak_wa" id="kontak_wa_admin"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin_admin"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="pendidikan_terakhir" id="pendidikan_admin"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="foto_diri" id="foto_diri_admin" accept="image/*"
                    ...
                    <div class="col-12" id="ahli_gizi_section"
                        style="display: {{ old('role_type', $user->userRole->role_type) === 'ahli_gizi' ? 'block' : 'none' }};">
                        <hr class="my-3">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nik_ahli_gizi" id="nik_ahli_gizi"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jabatan" id="jabatan"
                                    ...
                                    <option value="">Pilih Jabatan</option>
                                    <option value="Penanggung jawab"
                                        {{ old('jabatan', $ahliGizi->jabatan ?? '') === 'Penanggung jawab' ? 'selected' : '' }}>
                                        Penanggung jawab</option>
                                    <option value="Anggota"
                                        {{ old('jabatan', $ahliGizi->jabatan ?? '') === 'Anggota' ? 'selected' : '' }}>
                                        Anggota</option>
                                </select>
                                @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin"
                                    ...
                                    <option value="">Pilih Jenis Kelamin</option>
                                    <option value="Pria"
                                        {{ old('jenis_kelamin', $ahliGizi->jenis_kelamin ?? '') === 'Pria' ? 'selected' : '' }}>
                                        Pria</option>
                                    <option value="Wanita"
                                        {{ old('jenis_kelamin', $ahliGizi->jenis_kelamin ?? '') === 'Wanita' ? 'selected' : '' }}>
                                        Wanita</option>
                                </select>
                                @error('jenis_kelamin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="pendidikan_terakhir" id="pendidikan_terakhir"
                                    ...
                                    <option value="">Pilih Pendidikan</option>
                                    <option value="SD"
                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir ?? '') === 'SD' ? 'selected' : '' }}>
                                        SD</option>
                                    <option value="SMP"
                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir ?? '') === 'SMP' ? 'selected' : '' }}>
                                        SMP</option>
                                    <option value="SMA"
                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir ?? '') === 'SMA' ? 'selected' : '' }}>
                                        SMA</option>
                                    <option value="D1"
                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir ?? '') === 'D1' ? 'selected' : '' }}>
                                        D1</option>
                                    <option value="D2"
                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir ?? '') === 'D2' ? 'selected' : '' }}>
                                        D2</option>
                                    <option value="D3"
                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir ?? '') === 'D3' ? 'selected' : '' }}>
                                        D3</option>
                                    <option value="Sarjana"
                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir ?? '') === 'Sarjana' ? 'selected' : '' }}>
                                        Sarjana (S1/S2/S3)</option>
                                </select>
                                @error('pendidikan_terakhir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-12" id="produksi_section"
                        style="display: {{ old('role_type', $user->userRole->role_type) === 'produksi' ? 'block' : 'none' }};">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nik_produksi" id="nik_produksi"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jabatan" id="jabatan_prod"
                                    class="form-select @error('jabatan') is-invalid @enderror">
                                    <option value="">Pilih Jabatan</option>
                                    <option value="Penanggung jawab"
                                        {{ old('jabatan', $produksi->jabatan ?? '') === 'Penanggung jawab' ? 'selected' : '' }}>
                                        Penanggung jawab</option>
                                    <option value="Anggota"
                                        {{ old('jabatan', $produksi->jabatan ?? '') === 'Anggota' ? 'selected' : '' }}>
                                        Anggota</option>
                                </select>
                                @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kontak_wa" id="kontak_wa_prod"
                                    class="form-control @error('kontak_wa') is-invalid @enderror"
                                    placeholder="Contoh: 08123456789"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin_prod"
                                    class="form-select @error('jenis_kelamin') is-invalid @enderror">
                                    <option value="">Pilih Jenis Kelamin</option>
                                    <option value="Pria"
                            ...
                            <div class="col-md-6">
                                <label for="pendidikan_prod" class="form-label">Pendidikan Terakhir</label>
                                <select name="pendidikan" id="pendidikan_prod"
                                    class="form-select @error('pendidikan') is-invalid @enderror">
                                    <option value="">Pilih Pendidikan</option>
                                    <option value="SD"
                                        {{ old('pendidikan', $produksi->pendidikan ?? '') === 'SD' ? 'selected' : '' }}>SD
                                    </option>
                                    <option value="SMP"
                                        {{ old('pendidikan', $produksi->pendidikan ?? '') === 'SMP' ? 'selected' : '' }}>
                                        SMP</option>
                                    <option value="SMA"
                                        {{ old('pendidikan', $produksi->pendidikan ?? '') === 'SMA' ? 'selected' : '' }}>
                                        SMA</option>
                                    <option value="D1"
                                        {{ old('pendidikan', $produksi->pendidikan ?? '') === 'D1' ? 'selected' : '' }}>D1
                                    </option>
                                    <option value="D2"
                                        {{ old('pendidikan', $produksi->pendidikan ?? '') === 'D2' ? 'selected' : '' }}>D2
                                    </option>
                                    <option value="D3"
                                        {{ old('pendidikan', $produksi->pendidikan ?? '') === 'D3' ? 'selected' : '' }}>D3
                                    </option>
                                    <option value="Sarjana"
                                        {{ old('pendidikan', $produksi->pendidikan ?? '') === 'Sarjana' ? 'selected' : '' }}>
                                        Sarjana (S1/S2/S3)</option>
                                </select>
                                @error('pendidikan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="foto_diri" id="foto_diri_prod" accept="image/*"
                                    class="form-control @error('foto_diri') is-invalid @enderror">
                                @error('foto_diri')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="col-12" id="distributor_section"
                        style="display: {{ old('role_type', $user->userRole->role_type) === 'distributor' ? 'block' : 'none' }};">
                        <hr class="my-3">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nik_distribusi" id="nik_distribusi"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jabatan" id="jabatan_dist"
                                    class="form-select @error('jabatan') is-invalid @enderror">
                                    <option value="">Pilih Jabatan</option>
                                    <option value="Penanggung jawab"
                                        {{ old('jabatan', $distributor->jabatan ?? '') === 'Penanggung jawab' ? 'selected' : '' }}>
                                        Penanggung jawab</option>
                                    <option value="Anggota"
                                        {{ old('jabatan', $distributor->jabatan ?? '') === 'Anggota' ? 'selected' : '' }}>
                                        Anggota</option>
                                </select>
                                @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kontak_wa" id="kontak_wa_dist"
                                    class="form-control @error('kontak_wa') is-invalid @enderror"
                                    placeholder="Contoh: 08123456789"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin_dist"
                                    class="form-select @error('jenis_kelamin') is-invalid @enderror">
                                    <option value="">Pilih Jenis Kelamin</option>
                                    <option value="Pria"
                            ...
                            <div class="col-md-6">
                                <label for="pendidikan_dist" class="form-label">Pendidikan Terakhir</label>
                                <select name="pendidikan" id="pendidikan_dist"
                                    class="form-select @error('pendidikan') is-invalid @enderror">
                                    <option value="">Pilih Pendidikan</option>
                                    <option value="SD"
                                        {{ old('pendidikan', $distributor->pendidikan ?? '') === 'SD' ? 'selected' : '' }}>
                                        SD</option>
                                    <option value="SMP"
                                        {{ old('pendidikan', $distributor->pendidikan ?? '') === 'SMP' ? 'selected' : '' }}>
                                        SMP</option>
                                    <option value="SMA"
                                        {{ old('pendidikan', $distributor->pendidikan ?? '') === 'SMA' ? 'selected' : '' }}>
                                        SMA</option>
                                    <option value="D1"
                                        {{ old('pendidikan', $distributor->pendidikan ?? '') === 'D1' ? 'selected' : '' }}>
                                        D1</option>
                                    <option value="D2"
                                        {{ old('pendidikan', $distributor->pendidikan ?? '') === 'D2' ? 'selected' : '' }}>
                                        D2</option>
                                    <option value="D3"
                                        {{ old('pendidikan', $distributor->pendidikan ?? '') === 'D3' ? 'selected' : '' }}>
                                        D3</option>
                                    <option value="Sarjana"
                                        {{ old('pendidikan', $distributor->pendidikan ?? '') === 'Sarjana' ? 'selected' : '' }}>
                                        Sarjana (S1/S2/S3)</option>
                                </select>
                                @error('pendidikan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="foto_diri" id="foto_diri_dist" accept="image/*"
                                    class="form-control @error('foto_diri') is-invalid @enderror">
                                @error('foto_diri')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="col-12" id="akuntan_section"
                        style="display: {{ old('role_type', $user->userRole->role_type) === 'akuntan' ? 'block' : 'none' }};">
                        <hr class="my-3">
                        <h5 class="card-title mb-3">Informasi Spesifik Akuntan</h5>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label for="nik_akuntan" class="form-label">NIK Akuntan</label>
                                <input type="text" name="nik_akuntan" id="nik_akuntan"
                                    class="form-control @error('nik_akuntan') is-invalid @enderror"
                                    placeholder="Contoh: 3171234567890001"
                                    value="{{ old('nik_akuntan', $akuntan->nik_akuntan ?? '') }}">
                                @error('nik_akuntan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_lengkap" id="nama_lengkap_akuntan"
                                    class="form-control @error('nama_lengkap') is-invalid @enderror"
                                    placeholder="Nama lengkap sesuai KTP"
                                    value="{{ old('nama_lengkap', $akuntan->nama_lengkap ?? '') }}">
                                @error('nama_lengkap')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jabatan" id="jabatan_akuntan"
                                    class="form-select @error('jabatan') is-invalid @enderror">
                                    <option value="">Pilih Jabatan</option>
                                    <option value="Penanggung jawab"
                                        {{ old('jabatan', $akuntan->jabatan ?? '') === 'Penanggung jawab' ? 'selected' : '' }}>
                                        Penanggung jawab</option>
                                    <option value="Anggota"
                                        {{ old('jabatan', $akuntan->jabatan ?? '') === 'Anggota' ? 'selected' : '' }}>
                                        Anggota</option>
                                </select>
                                @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <label for="kontak_wa_akuntan" class="form-label">Nomor WhatsApp / Telepon</label>
                                <input type="text" name="kontak_wa" id="kontak_wa_akuntan"
                                    class="form-control @error('kontak_wa') is-invalid @enderror"
                                    placeholder="Contoh: 08123456789"
                                    value="{{ old('kontak_wa', $akuntan->kontak_wa ?? '') }}">
                                @error('kontak_wa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin_akuntan"
                                    class="form-select @error('jenis_kelamin') is-invalid @enderror">
                                    <option value="">Pilih Jenis Kelamin</option>
                                    <option value="Pria"
                                        {{ old('jenis_kelamin', $akuntan->jenis_kelamin ?? '') === 'Pria' ? 'selected' : '' }}>
                                        Pria</option>
                                    <option value="Wanita"
                                        {{ old('jenis_kelamin', $akuntan->jenis_kelamin ?? '') === 'Wanita' ? 'selected' : '' }}>
                                        Wanita</option>
                                </select>
                                @error('jenis_kelamin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <label for="pendidikan_akuntan" class="form-label">Pendidikan Terakhir</label>
                                <select name="pendidikan" id="pendidikan_akuntan"
                                    class="form-select @error('pendidikan') is-invalid @enderror">
                                    <option value="">Pilih Pendidikan</option>
                                    <option value="SD"
                                        {{ old('pendidikan', $akuntan->pendidikan ?? '') === 'SD' ? 'selected' : '' }}>
                                        SD</option>
                                    <option value="SMP"
                                        {{ old('pendidikan', $akuntan->pendidikan ?? '') === 'SMP' ? 'selected' : '' }}>
                                        SMP</option>
                                    <option value="SMA"
                                        {{ old('pendidikan', $akuntan->pendidikan ?? '') === 'SMA' ? 'selected' : '' }}>
                                        SMA</option>
                                    <option value="D1"
                                        {{ old('pendidikan', $akuntan->pendidikan ?? '') === 'D1' ? 'selected' : '' }}>
                                        D1</option>
                                    <option value="D2"
                                        {{ old('pendidikan', $akuntan->pendidikan ?? '') === 'D2' ? 'selected' : '' }}>
                                        D2</option>
                                    <option value="D3"
                                        {{ old('pendidikan', $akuntan->pendidikan ?? '') === 'D3' ? 'selected' : '' }}>
                                        D3</option>
                                    <option value="Sarjana"
                                        {{ old('pendidikan', $akuntan->pendidikan ?? '') === 'Sarjana' ? 'selected' : '' }}>
                                        Sarjana (S1/S2/S3)</option>
                                </select>
                                @error('pendidikan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="foto_diri" id="foto_diri_akuntan" accept="image/*"
                                    class="form-control @error('foto_diri') is-invalid @enderror">
                                @error('foto_diri')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mt-3">
                                    <img id="image_preview_akuntan"
                                        src="{{ ($akuntan ?? false) && $akuntan->foto_diri ? Storage::url($akuntan->foto_diri) : '#' }}"
                                        alt="Preview Foto Diri" class="img-fluid rounded border"
                                        style="max-height: 200px; object-fit: cover; {{ ($akuntan ?? false) && $akuntan->foto_diri ? 'display: block;' : 'display: none;' }}">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="alert alert-info alert-dismissible" role="alert">
            ...
            <ul class="mb-0">
                ...
                <li>Perubahan role akan menampilkan/menyembunyikan form tambahan terkait (seperti form spesifik Ahli Gizi).
                </li>
            </ul>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            handleImagePreview(fotoInputAdmin, imagePreviewAdmin,
                "{{ ($adminGudang ?? false) && $adminGudang->foto_diri ? Storage::url($adminGudang->foto_diri) : '#' }}"
                );
            handleImagePreview(fotoInput, imagePreview,
                "{{ ($ahliGizi ?? false) && $ahliGizi->foto_diri ? Storage::url($ahliGizi->foto_diri) : '#' }}"
                );
            handleImagePreview(fotoInputProd, imagePreviewProd,
                "{{ ($produksi ?? false) && $produksi->foto_diri ? Storage::url($produksi->foto_diri) : '#' }}"
                );
            handleImagePreview(fotoInputDist, imagePreviewDist,
                "{{ ($distributor ?? false) && $distributor->foto_diri ? Storage::url($distributor->foto_diri) : '#' }}"
                );
