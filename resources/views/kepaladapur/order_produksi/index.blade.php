...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <nav class="d-flex align-items-center mb-2">
                        <a href="{{ route('kepala-dapur.dashboard', ['dapur' => $idDapur]) }}" class="text-muted me-2">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('kepala-dapur.order-produksi.index') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-12 d-flex justify-content-end gap-2 mt-3">
                    @if (request()->hasAny(['search', 'status', 'date_from', 'date_to']) && request('status') !== 'all')
                        <a href="{{ route('kepala-dapur.order-produksi.index') }}" class="btn btn-outline-secondary">
                            Reset Filter
                        </a>
                    @endif
                                ...
                                <tr class="{{ $isStokKurang ? 'table-danger' : '' }}" 
                                    ...
                                    <td>
                                        @if ($hasPendingShortage)
                                            <span class="badge bg-label-danger">
                                                ...
                                                @formatNumber($pendingShortages->count()) Item
                                            </span>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('kepala-dapur.order-produksi.show', $order->id_order) }}" 
            ...
            @else
                ...
                <div class="text-center py-6">
                    @if (request()->hasAny(['search', 'status', 'date_from', 'date_to']))
                        ...
                        <a href="{{ route('kepala-dapur.order-produksi.index') }}" class="btn btn-outline-primary">
                            Reset Filter
                        </a>
                    @else
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (updateStatusModal) {
            updateStatusModal.addEventListener('show.bs.modal', function (event) {
                ...
                const baseUrl = '{{ route("kepala-dapur.order-produksi.update-status", ":id") }}';
