...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <nav class="d-flex align-items-center mb-2">
                        ...
                        <i class="bx bx-chevron-right me-2"></i>
                        <span class="text-dark">Edit {{ $templateItem->nama_bahan }}</span>
                    </nav>
                    <h4 class="mb-1">Edit Template Bahan</h4>
                    <p class="mb-0 text-muted">Perbarui detail template bahan</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form action="{{ route('kepala-dapur.template-items.update', $templateItem) }}" method="POST" class="row g-4">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4 mt-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="satuan" 
                                ...
                                @foreach ($satuans as $satuan)
                                    <option value="{{ $satuan }}"
                                            {{ old('satuan', $templateItem->satuan) == $satuan ? 'selected' : '' }}>
                                        {{ ucfirst($satuan) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="keterangan" 
                                      ...
                                      placeholder="Deskripsi atau catatan tentang bahan ini">{{ old('keterangan', $templateItem->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <p id="preview-keterangan">Keterangan: {{ $templateItem->keterangan ?: '-' }}</p>
        </div>
    </div>
    ...
    <div class="alert alert-info alert-dismissible" role="alert">
        ...
        <ul class="mb-0">
            ...
            <li>Pastikan perubahan tidak mengganggu menu atau stock yang menggunakan bahan ini.</li>
        </ul>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
</div>
