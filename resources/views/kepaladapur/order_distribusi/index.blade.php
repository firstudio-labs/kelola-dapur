...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('kepala-dapur.order-distribusi.index') }}" class="row g-3">
                <div class="col-md-3">
                                ...
                                <tr data-search="{{ strtolower($transaksi->nama_paket ?? '') }}" data-status="{{ $order->status }}">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('kepala-dapur.order-distribusi.show', $order->id_distribusi) }}" class="btn btn-sm btn-outline-info">
                        ...
                        <div class="card mb-3 border shadow-none mobile-card-item" data-search="{{ strtolower($transaksi->nama_paket ?? '') }}">
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('kepala-dapur.order-distribusi.show', $order->id_distribusi) }}" class="btn btn-sm btn-primary">
                                        Detail
                                    </a>
                                </div>
                            </div>
            ...
            @else
                ...
                <div class="text-center py-6">
                    @if (request()->hasAny(["search", "status", "date_from", "date_to"]))
                        ...
                        <a href="{{ route('kepala-dapur.order-distribusi.index') }}" class="btn btn-outline-primary">Reset Filter</a>
                    @else
