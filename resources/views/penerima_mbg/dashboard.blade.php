                ...
                <div class="col-12 col-lg-8">
                    <div class="card h-100 shadow-sm border-0">
                        <div
                            ...
                            <h5 class="mb-0 fw-bold"><i class="bx bx-time-five me-2 text-primary"></i>Transaksi Hari Ini
                            </h5>
                            <a href="{{ route('penerima-mbg.history.index') }}"
                                class="btn btn-sm btn-outline-primary px-3">Riwayat</a>
                        </div>
                        <div class="card-body p-4">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    class="avatar avatar-md bg-white shadow-sm rounded-circle me-3 d-flex align-items-center justify-content-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <span class="badge bg-label-info me-2 py-0 px-2 small">
                                                            ...
                                                            {{ $delivery->porsi_besar + $delivery->porsi_kecil }} Porsi
                                                        </span>
                                                        <small class="text-muted">({{ $delivery->porsi_besar }}B /
                                                            {{ $delivery->porsi_kecil }}K)</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-end d-flex flex-column align-items-end">
                                                <span
                                                    class="badge bg-label-{{ $badgeColor }} mb-2">{{ $badgeLabel }}</span>
                                                <a href="{{ route('penerima-mbg.history.show', $delivery->id_detail) }}"
                            ...
                            @empty
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted small mt-1">Gunakan menu Riwayat untuk melihat transaksi
                                        sebelumnya.</p>
                                </div>
                            @endforelse
                        </div>
                            ...
                            <div class="card shadow-sm border-0 bg-primary text-white overflow-hidden"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between p-4 position-relative">
                                    ...
                                    <div class="z-index-1">
                                        ...
                                        <h2 class="text-white mb-0 fw-bold">{{ $penerima->jumlah_porsi }} <small
                                                class="fs-6 fw-normal">Porsi</small></h2>
                                    </div>
                                    @if ($penerima->isApproved())
                                        <button class="btn btn-white btn-sm text-primary fw-bold w-100 mt-3"
                                            data-bs-toggle="modal" data-bs-target="#modalUpdatePorsi">
                                            Update Porsi
                                        </button>
                                    @endif
                                </div>
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div
                                            class="avatar avatar-sm bg-label-secondary rounded me-2 d-flex align-items-center justify-content-center">
                                            <i class="bx bx-building fs-5"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <small class="text-muted d-block small" style="font-size: 0.7rem;">Dapur
                                                SPPG</small>
                                            <span class="fw-semibold text-dark small"
                                                style="font-size: 0.85rem;">{{ $penerima->dapur?->nama_dapur ?: '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        @php
                                        ...
                                        @endphp
                                        <div
                                            class="avatar avatar-sm bg-label-{{ $statusColor }} rounded me-2 d-flex align-items-center justify-content-center">
                                            <i class="bx bx-check-shield fs-5"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <small class="text-muted d-block small" style="font-size: 0.7rem;">Status
                                                Akun</small>
                                            <span class="badge bg-label-{{ $statusColor }} py-0 px-2 small"
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="{{ route('penerima-mbg.profile.edit') }}"
                                            class="btn btn-label-secondary btn-sm text-start">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div class="input-group input-group-lg justify-content-center border rounded overflow-hidden">
                                <input type="number" name="jumlah_porsi" class="form-control text-center border-0"
                                    value="{{ old('jumlah_porsi', $penerima->jumlah_porsi) }}" min="1"
