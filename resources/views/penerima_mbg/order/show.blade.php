    ...
    <div class="row g-4">
                ...
                <div class="card-body">
                    ...
                    @if($menus->count())
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            @foreach($menus as $dtd)
                                <span class="badge bg-label-primary p-2" style="font-size:.85rem;">
        ...
        <div class="col-12 col-xl-5">
            @if($sudahKonfirmasi)
                ...
                <div class="card border-{{ $badgeColor }} border-2 h-100">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="bx bx-{{ $statusPenerimaan === 'diterima' ? 'check-circle text-success' : 'x-circle text-danger' }} me-2"></i>
                        ...
                        <table class="table table-borderless table-sm mb-3">
                            <tbody>
                                ...
                                <tr class="table-{{ $badgeColor }} fw-semibold">
                                    ...
                                    <td>{{ $detail->porsi_besar_diterima ?? '—' }} {{ $detail->porsi_besar_diterima !== null ? 'porsi' : '' }}</td>
                                </tr>
                                <tr class="table-{{ $badgeColor }} fw-semibold">
                                    <th class="ps-0">Porsi Kecil Diterima</th>
                                    <td>{{ $detail->porsi_kecil_diterima ?? '—' }} {{ $detail->porsi_kecil_diterima !== null ? 'porsi' : '' }}</td>
                                </tr>
                            </tbody>
                        </table>
            ...
            @else
                ...
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bx bx-check-double me-2 text-warning"></i>Konfirmasi Penerimaan</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('penerima-mbg.history.store', $detail->id_detail) }}"
                              method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="ulasan"
                                          rows="3"
                                          class="form-control @error('ulasan') is-invalid @enderror"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnTerima) btnTerima.addEventListener('click', function () { hidden.value = 'diterima'; });
    if (btnTolak)  btnTolak.addEventListener('click',  function () { hidden.value = 'ditolak'; });
});
</script>
@endpush
@endsection
