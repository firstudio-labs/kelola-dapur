        ...
        <div class="card mb-4">
            <div class="card-body">
                <nav class="d-flex align-items-center mb-2">
                    ...
                    <i class="bx bx-chevron-right me-2"></i>
                    <span class="text-dark">Edit Promo</span>
                </nav>
                <h4 class="mb-1">Edit Kode Promo</h4>
                <p class="mb-0 text-muted">Perbarui informasi kode promo</p>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            method="POST"
                            action="{{ route("superadmin.promo-codes.update", $promoCode) }}"
                        >
                            @csrf
                            @method("PUT")
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old("kode_promo", $promoCode->kode_promo) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input
                                        ...
                                        value="{{ old("persentase_diskon", $promoCode->persentase_diskon) }}"
                                        min="1"
                                        max="100"
                                        placeholder="20"
                                        required
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old("tanggal_mulai", $promoCode->tanggal_mulai) }}"
                                    required
                                />
                                @error("tanggal_mulai")
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old("tanggal_berakhir", $promoCode->tanggal_berakhir) }}"
                                    required
                                />
                        ...
                        <div class="promo-preview text-center">
                            ...
                            <div class="promo-details">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span
                                        class="badge promo-status bg-label-{{ $promoCode->is_active ? "success" : "danger" }} {{ $promoCode->isExpired() ? "bg-label-secondary" : "" }}"
                                    >
