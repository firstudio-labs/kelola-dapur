        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">
                    Kelola template bahan untuk menu makanan
                </p>
            </div>
            <a
        ...
        <div class="card">
            ...
            >
                ...
                <small class="text-muted">
                    @if (request("search"))
                        Hasil pencarian:
                        <strong>{{ $templateItems->total() }}</strong>
                        dari "{{ request("search") }}"
                    @else
                        Total:
                        <strong>{{ $templateItems->total() }}</strong>
            ...
            @if ($templateItems->count() > 0)
                <div class="card-footer">
                    <small class="text-muted">
                        Menampilkan {{ $templateItems->firstItem() }} -
                        {{ $templateItems->lastItem() }} dari
                        {{ $templateItems->total() }} data
                        @if (request("search"))
