        ...
        <div class="card mb-4">
            <div class="card-body">
                <nav class="d-flex align-items-center mb-2">
                    ...
                    <i class="bx bx-chevron-right me-2"></i>
                    <span class="text-dark">Tambah Paket</span>
                </nav>
                <h4 class="mb-1">Tambah Paket Subscription</h4>
                <p class="mb-0 text-muted">
                    Buat paket subscription baru untuk dapur
                </p>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            method="POST"
                            action="{{ route("superadmin.subscription-packages.store") }}"
                        >
                            @csrf
...
{{ old("deskripsi") }}</textarea
                            ...
                            <div class="mb-3">
                                ...
                                >
                                    ...
                                    <option
                                        value="30"
                                        {{ old("durasi_hari") == "30" ? "selected" : "" }}
                                    >
                                        30 Hari (1 Bulan)
                                    </option>
                                    <option
                                        value="90"
                                        {{ old("durasi_hari") == "90" ? "selected" : "" }}
                                    >
                                        90 Hari (3 Bulan)
                                    </option>
                                    <option
                                        value="180"
                                        {{ old("durasi_hari") == "180" ? "selected" : "" }}
                                    >
                                        180 Hari (6 Bulan)
                                    </option>
                                    <option
                                        value="365"
                                        {{ old("durasi_hari") == "365" ? "selected" : "" }}
                                    >
                                        365 Hari (1 Tahun)
                                    </option>
                                </select>
                    ...
                    <div class="card-body">
                        <div class="package-preview">
                            <div class="text-center mb-3">
                                ...
                                <h6 class="package-name mb-1">Nama Paket</h6>
                                <p
                            ...
                            <div class="package-details">
                                ...
                                >
                                    ...
                                    <strong class="package-price">Rp 0</strong>
                                </div>
                                <div
                                    class="d-flex justify-content-between mb-2"
                                >
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span
                                        class="badge package-status bg-label-success"
                                    >
                                        Aktif
                                    </span>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updatePreview() {
                // Update name
                previewName.textContent = namaInput.value || 'Nama Paket';
