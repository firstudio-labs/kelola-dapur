...
{{ old("deskripsi", $menuMakanan->deskripsi) }}</textarea
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">
                                    Format: JPG, PNG, GIF. Maksimal 2MB. Biarkan
                                    kosong untuk mempertahankan gambar saat ini.
                                </small>
                                <div class="mt-2">
                                    <img
                    ...
                    <div class="col-12 mt-4">
                        ...
                        <p class="text-muted mb-3">
                            Perbarui atau tambahkan bahan untuk menu ini
                        </p>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input
                                                        ...
                                                        min="0.0001"
                                                        required
                                                        class="form-control @error("bahan_menu." . $index . ".jumlah_per_porsi") is-invalid @enderror"
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <span
                            ...
                            class="badge bg-label-{{ $menuMakanan->is_active ? "success" : "danger" }}"
                        >
                        ...
                        <ul id="preview-bahan-list" class="list-unstyled">
                            ...
                            @if ($menuMakanan->bahanMenu->isEmpty())
                                <li class="text-muted">
        ...
        <div class="alert alert-info alert-dismissible" role="alert">
            ...
            <ul class="mb-0">
                ...
                <li>
                    Gambar opsional, biarkan kosong untuk mempertahankan gambar
                    saat ini
                </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            let bahanIndex = {{ $menuMakanan->bahanMenu->count() }};
            ...
            document.addEventListener('click', function (e) {
                if (e.target.closest('.remove-bahan')) {
                    ...
                    if (document.querySelectorAll('.bahan-row').length > 1) {
                        ...
                        alert('Minimal satu bahan harus tetap ada.');
                    }
                }
            });
