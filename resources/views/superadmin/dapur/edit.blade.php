    ...
    {{ old('alamat', $dapur->alamat) }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="telepon" id="telepon"
                            class="form-control @error('telepon') is-invalid @enderror" placeholder="Contoh: 0211234567"
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="active" {{ old('status', $dapur->status) === 'active' ? 'selected' : '' }}>
                                Aktif
                            </option>
                            <option value="inactive" {{ old('status', $dapur->status) === 'inactive' ? 'selected' : '' }}>
                                Tidak Aktif
                            </option>
                        </select>
                        @error('status')
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="badge ms-2" id="preview-status-badge">
                                        ...
                                        <br />
                                        <small class="text-muted" id="preview-telepon"
                                            @if (!old('telepon', $dapur->telepon)) style="display: none;" @endif>
                                            <i class="bx bx-phone me-1"></i>
                                            <span id="preview-telepon-text">
                ...
                statusSelect.addEventListener('change', function() {
                    ...
                    if (this.value && badgeClasses[this.value]) {
                        previewStatusBadge.innerHTML =
                            `<span class="badge ${badgeClasses[this.value]}">${statusTexts[this.value]}</span>`;
                    } else {
                        previewStatusBadge.innerHTML =
