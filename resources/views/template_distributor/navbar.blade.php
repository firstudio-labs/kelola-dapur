    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        <div class="navbar-nav align-items-center">
            <div class="nav-item d-flex align-items-center">
                <span class="fw-semibold">Distributor - {{ auth()->user()->userRole->dapur->nama_dapur ?? 'Dapur' }}</span>
            </div>
        </div>
                        ...
                        <a class="dropdown-item" href="{{ route('distributor.profile.edit') }}">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <small class="text-muted">{{ auth()->user()->distributor->jabatan ?? 'Distributor' }}</small>
                                </div>
                            </div>
                        </a>
                    </li>
