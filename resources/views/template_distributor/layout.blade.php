...
<head>
    ...
    <title>Distributor - Kelola Dapur</title>
    @stack("styles")
...
<body>
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            @include("template_distributor.sidebar")
            <div class="layout-page">
                @include("template_distributor.navbar")
    ...
    <div class="mobile-bottom-nav d-md-none">
        <a href="{{ route('distributor.dashboard') }}" class="nav-item {{ Request::is('distributor/dashboard*') ? 'active' : '' }}">
            <i class="bx bx-home-circle"></i>
            <span>Dashboard</span>
        </a>
        <a href="{{ route('distributor.order.index') }}" class="nav-item {{ Request::is('distributor/order-distribusi*') ? 'active' : '' }}">
            <i class="bx bx-package"></i>
            <span>Pengiriman</span>
        </a>
        <a href="{{ route('distributor.profile.edit') }}" class="nav-item {{ Request::is('distributor/profile*') ? 'active' : '' }}">
