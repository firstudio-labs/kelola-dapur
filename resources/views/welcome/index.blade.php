...
<html lang="en" class="scroll-smooth">
    <head>
        ...
        <link
            rel="stylesheet"
            href="play-tailwind-1.0.0/assets/css/swiper-bundle.min.css"
        />
        <link
            rel="stylesheet"
            href="play-tailwind-1.0.0/assets/css/animate.css"
        />
        <link
            rel="stylesheet"
            href="./play-tailwind-1.0.0/src/css/tailwind.css"
        />
    ...
    <body>
            ...
            <div class="container px-4 mx-auto">
                <div class="relative flex items-center justify-between -mx-4">
                    <div class="max-w-full px-4 w-60">
                        <a
                            href="index.html"
                            class="block w-full py-5 navbar-logo"
                        >
                            <img
                                src="play-tailwind-1.0.0/assets/images/logo/logo_kelola_dapur_white.png"
                                alt="logo"
                    ...
                    <div class="flex items-center justify-between w-full px-4">
                        ...
                        <div
                            class="flex items-center justify-end pr-16 lg:pr-0"
                        >
                            <label
                                for="themeSwitcher"
                ...
                <div class="flex flex-wrap items-center -mx-4">
                    <div class="w-full px-4">
                        ...
                        >
                            ...
                            >
                                Kelola Dapur,ciptakan hasil yang teratur
                            </h1>
                            <p
                    ...
                    <div class="w-full px-4">
                        ...
                        >
                            <div class="mt-16">
                                <img
                                    src="play-tailwind-1.0.0/assets/images/hero/hero-image.png"
                                    alt="hero"
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                        ...
                        >
                            ...
                            >
                                ...
                                <i
                                    class="bx bxs-dollar-circle text-white text-4xl"
                                ></i>
                            </div>
                            <h4
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- Boxicons Restaurant -->
                                <i
                                    class="bx bxs-bowl-hot text-white text-4xl"
                                ></i>
                            </div>
                            <h4
                                class="mb-3 text-xl font-bold text-dark dark:text-white"
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                        ...
                        >
                            ...
                            >
                                ...
                                <i
                                    class="bx bxs-package text-white text-4xl"
                                ></i>
                            </div>
                            <h4
                                class="mb-3 text-xl font-bold text-dark dark:text-white"
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                        ...
                        >
                            ...
                            >
                                ...
                                <i
                                    class="bx bxs-report text-white text-4xl"
                                ></i>
                            </div>
                            <h4
                                class="mb-3 text-xl font-bold text-dark dark:text-white"
            ...
            <div class="container px-4 mx-auto">
                <div class="wow fadeInUp" data-wow-delay=".2s">
                    <div class="flex flex-wrap items-center -mx-4">
                        ...
                        <div class="w-full px-4 lg:w-1/2">
                            <div
                                class="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4"
                            >
                                <div
                                    class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4"
                                >
                                    <div
                    ...
                    @forelse ($subscriptionPackages ?? [] as $package)
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            ...
                            >
                                ...
                                <div class="mb-[50px]">
                                    <h5
                                        class="mb-5 text-lg font-medium text-dark dark:text-white"
                                    >
                                        Fitur Utama
                                    </h5>
                                    <div class="flex flex-col gap-[14px]">
                                        ...
                                        @foreach ($features as $feature)
                                            @if (trim($feature))
                                                ...
                                                >
                                                    <i
                                                        class="bx bx-check text-primary text-xl mt-0.5"
                                                    ></i>
                                                    <p
                                                        class="text-base text-body-color dark:text-dark-6"
                                                    >
                                ...
                                @if ($package->is_active)
                                    <a
                                        href="{{ route("kepala-dapur.subscription.choose-package", ["dapur" => session("selected_dapur_id", 1)]) }}?package={{ $package->id_subscription_package }}"
                                ...
                                @else
                                    <button
                                        disabled
                                        class="inline-block py-3 text-base font-medium text-center text-gray-500 transition rounded-md bg-gray-300 px-7 cursor-not-allowed"
                                    >
                                        Tidak Tersedia
                                    </button>
                                @endif
                    ...
                    @empty
                        <div class="w-full px-4">
                            <div class="text-center py-10">
                                <p
                                    class="text-lg text-body-color dark:text-dark-6"
                                >
                                    Paket berlangganan sedang tidak tersedia.
        ...
        <section
            id="faq"
            class="relative z-20 overflow-hidden bg-gray-1 pb-8 pt-20 dark:bg-dark-2 md:py-[120px]"
        >
            <div class="container px-4 mx-auto">
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full px-4">
                        <div
                            class="mx-auto mb-[60px] max-w-[520px] text-center"
                        >
                            <span
                                class="block mb-2 text-lg font-semibold text-primary"
                            >
                    ...
                    <div class="space-y-12">
                        ...
                        <div class="flex w-full max-w-full">
                            ...
                            <div>
                                ...
                                <p class="mb-4 text-base text-body-color dark:text-dark-6">
                                    JL Kauman Barat IV, Palebon, Kec. Pedurungan, Kota Semarang, Jawa Tengah
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex w-full max-w-full">
                            ...
                            <div>
                                ...
                                <!-- WhatsApp -->
                                <div class="mb-1 flex items-center">
                                    <a href="http://wa.me/+6285117494221" class="text-primary dark:text-white transition-colors mr-3">
                                        <svg width="18" height="18" viewBox="0 0 24 24" class="fill-current">
    ...
    <!-- ====== Contact End ====== -->
        ...
        >
            <div class="container px-4 mx-auto">
                <div class="flex flex-wrap -mx-4">
                    <div
                        class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12"
                    >
                    ...
                    <div
                        class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12"
                    >
                        <div class="w-full mb-10">
                ...
                <div class="container px-4 mx-auto">
                    <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                            <div
                                class="flex justify-center my-1 md:justify-end"
                            >
            ...
            <div>
                <span class="absolute left-0 top-0 z-[-1]">
                    <img
                        src="play-tailwind-1.0.0/assets/images/footer/shape-1.svg"
                        alt=""
                    />
                </span>
                ...
                <span class="absolute bottom-0 right-0 z-[-1]">
                    <img
                        src="play-tailwind-1.0.0/assets/images/footer/shape-3.svg"
                        alt=""
                    />
                </span>
