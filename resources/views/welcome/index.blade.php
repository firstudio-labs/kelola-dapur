                ...
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        ...
                        <p
                            ...
                            Kelola menu, stok, dan kebutuhan harian secara teratur. Berikan Nutrisi yang Tepat Sasaran.
                            Semuanya Dimulai dari Pengelolaan Data yang Sederhana.
                        </p>
                        ...
                        <div class="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                            <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                                <div class="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]">
                                    <img src="./play-tailwind-1.0.0/assets/images/about/about_keloladapur1.png"
                                        alt="about image" class="object-cover object-center w-full h-full" />
                                </div>
                            </div>
                            ...
                            <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                                <div
                                    ...
                                    <img src="./play-tailwind-1.0.0/assets/images/about/about_keloladapur2.png"
                                        alt="about image" class="object-cover object-center w-full h-full" />
                                </div>
                                    ...
                                    @foreach ($features as $feature)
                                        @if (trim($feature))
                                            <div class="flex items-start gap-2">
                                                <i class="bx bx-check text-primary text-xl mt-0.5"></i>
                                                <p class="text-base text-body-color dark:text-dark-6">
                                                    {{ trim($feature) }}
                                                </p>
                                            </div>
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[520px] text-center">
                        ...
                        <p class="mx-auto max-w-[485px] text-base text-body-color dark:text-dark-6">
                            Temukan jawaban anda tentang sistem manajemen dapur kami.
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <div class="mb-12 flex lg:mb-[70px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-dark-6">
                                Ya, sistem kami fleksibel dan dapat disesuaikan dengan kebutuhan dapur kecil hingga
                                besar.
                            </p>
                        </div>
                    </div>
                ...
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <div class="mb-12 flex lg:mb-[70px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-dark-6">
                                Tentu saja akan terdapat pembaruan fitur di masa mendatang, terutama tentang kebutuhan
                                dapur
                ...
                <div class="w-full px-4 lg:w-7/12 xl:w-8/12">
                    <div class="ud-contact-content-wrapper">
                        <div class="ud-contact-title mb-12 lg:mb-[150px]">
                            ...
                            <h2
                                class="max-w-[275px] text-[35px] font-semibold leading-[1.14] text-dark dark:text-white">
