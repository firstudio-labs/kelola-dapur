...
@section("content")
    <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <nav class="d-flex align-items-center mb-2">
                            ...
                            <span class="text-dark">Kelola Stok</span>
                        </nav>
                        <h4 class="mb-1">
                            Kelola Stok - {{ $dapur->nama_dapur }}
                        </h4>
                        <p class="mb-0 text-muted">
                            Kelola stok bahan makanan untuk dapur
                            {{ $dapur->nama_dapur }}
                        </p>
                    </div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form
                    method="GET"
                    action="{{ route("admin-gudang.stock.index", $dapur) }}"
                    class="row g-3"
                >
                    <div class="col-md-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a
                                                    href="{{ route("admin-gudang.stock.show", [$dapur, $stockItem]) }}"
                                                ...
                                                <button
                                                    ...
                                                    data-stock-id="{{ $stockItem->id_stock_item }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Auto-refresh page if there are validation errors
            @if($errors->any())
