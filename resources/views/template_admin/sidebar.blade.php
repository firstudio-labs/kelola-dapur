    ...
    <ul class="menu-inner py-1">
        ...
        >
            ...
            <ul class="menu-sub">
                ...
                <li
                    class="menu-item {{ request()->routeIs("superadmin.dapur.create") ? "active" : "" }}"
                >
                    <a
        ...
        <li
            class="menu-item {{ request()->routeIs("superadmin.users.*") ? "active open" : "" }}"
        >
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                <li
                    class="menu-item {{ request()->routeIs("superadmin.users.index") ? "active" : "" }}"
                >
                    <a
                ...
                <li
                    class="menu-item {{ request()->routeIs("superadmin.users.create") ? "active" : "" }}"
                >
                    <a
        ...
        <li
            class="menu-item {{ request()->routeIs("superadmin.stock-items.*") ? "active" : "" }}"
        >
            <a
                href="{{ route("superadmin.stock-items.index") }}"
                class="menu-link"
            >
        ...
        <li
            class="menu-item {{ request()->routeIs("superadmin.approvals.*") ? "active" : "" }}"
        >
            <a
                href="{{ route("superadmin.approvals.index") }}"
                class="menu-link"
            >
