    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->routeIs('superadmin.dapur.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('superadmin.dapur.create') ? 'active' : '' }}">
                    <a href="{{ route('superadmin.dapur.create') }}" class="menu-link">
                        <div>Tambah Dapur</div>
                    </a>
                </li>
            </ul>
        </li>

        <!-- Menu Makanan dengan Dropdown -->
        ...
        <!-- Template Bahan dengan Dropdown -->
        ...
        <!-- Users dengan Dropdown -->
        <li class="menu-item {{ request()->routeIs('superadmin.users.*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('superadmin.users.index') ? 'active' : '' }}">
                    <a href="{{ route('superadmin.users.index') }}" class="menu-link">
                        <div>Daftar Users</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->routeIs('superadmin.users.create') ? 'active' : '' }}">
                    <a href="{{ route('superadmin.users.create') }}" class="menu-link">
                        <div>Tambah User</div>
                    </a>
                </li>
            </ul>
        ...
        <li class="menu-item {{ request()->routeIs('superadmin.stock-items.*') ? 'active' : '' }}">
            <a href="{{ route('superadmin.stock-items.index') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->routeIs('superadmin.approvals.*') ? 'active' : '' }}">
            <a href="{{ route('superadmin.approvals.index') }}" class="menu-link">
        ...
        {{-- <li class="menu-item {{ request()->routeIs('superadmin.master.*') || request()->routeIs('superadmin.kategori-artikel.*') || request()->routeIs('superadmin.kategori-produk.*') || request()->routeIs('superadmin.kategori-gambar.*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-category"></i>
                <div>Master</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('superadmin.kategori-artikel.*') ? 'active' : '' }}">
                    <a href="{{ route('superadmin.kategori-artikel.index') }}" class="menu-link">
                        <div>Kategori Artikel</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->routeIs('superadmin.kategori-produk.*') ? 'active' : '' }}">
                    <a href="{{ route('superadmin.kategori-produk.index') }}" class="menu-link">
                        <div>Kategori Produk</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->routeIs('superadmin.kategori-gambar.*') ? 'active' : '' }}">
                    <a href="{{ route('superadmin.kategori-gambar.index') }}" class="menu-link">
