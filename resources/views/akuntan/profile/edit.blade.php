    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('akuntan.profile.security.edit') }}">
            ...
            <div class="card mb-4">
                ...
                <form id="formAccountSettings" method="POST" action="{{ route('akuntan.profile.update') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <hr class="my-3">
                                <h6 class="fw-semibold mb-3">Detail Personal Akuntan</h6>
                                ...
                                <div class="d-flex align-items-start align-items-sm-center justify-content-center gap-4 mb-4">
                                    <div class="position-relative">
                                        <img id="uploadedAvatar"
                                            src="{{ $akuntan->foto_diri ? Storage::url($akuntan->foto_diri) : asset('admin/assets/img/avatars/1.png') }}"
                                    ...
                                    <div class="button-wrapper text-start">
                                        <button type="button"
                                            class="btn btn-outline-secondary btn-sm mb-2 account-image-reset {{ !$akuntan->foto_diri ? 'd-none' : '' }}">
                                ...
                                <div class="row g-4">
                                    <div class="mb-3 col-md-6">
                                        <label for="nik_akuntan" class="form-label">NIK (Nomor Induk
                                            Kependudukan)</label>
                                        <input class="form-control @error('nik_akuntan') is-invalid @enderror"
                                            type="text" id="nik_akuntan" name="nik_akuntan"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select name="pendidikan" id="pendidikan"
                                            ...
                                            @foreach (['SD', 'SMP', 'SMA', 'D1', 'D2', 'D3', 'Sarjana'] as $edu)
                                                <option value="{{ $edu }}"
                                                    {{ old('pendidikan', $akuntan->pendidikan) === $edu ? 'selected' : '' }}>
                                                    {{ $edu }}</option>
                                            @endforeach
                                        </select>
                                        @error('pendidikan')
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control @error('jabatan') is-invalid @enderror" type="text"
                                            id="jabatan" name="jabatan" value="{{ old('jabatan', $akuntan->jabatan) }}" />
                                        @error('jabatan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="hidden" name="province_name" id="province_name_hidden"
                                    value="{{ old('province_name', $akuntan->province_name) }}">
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="hidden" name="regency_name" id="regency_name_hidden"
                                    value="{{ old('regency_name', $akuntan->regency_name) }}">
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="hidden" name="district_name" id="district_name_hidden"
                                    value="{{ old('district_name', $akuntan->district_name) }}">
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="hidden" name="village_name" id="village_name_hidden"
                                    value="{{ old('village_name', $akuntan->village_name) }}">
                            </div>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control @error('alamat_detail') is-invalid @enderror"
                                    ...
                                    placeholder="Nama jalan, gedung, no rumah, RT/RW, dsb.">{{ old('alamat_detail', $akuntan->alamat_detail) }}</textarea>
                                @error('alamat_detail')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mt-2 text-end">
                            ...
                            <a href="{{ route('akuntan.dashboard') }}" class="btn btn-outline-secondary">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (uploadInput) {
                uploadInput.onchange = (e) => {
                    ...
                    if (file) { uploadedAvatar.src = URL.createObjectURL(file); }
                };
            }
            ...
            if (accountImageReset) {
                accountImageReset.onclick = () => {
                    uploadInput.value = '';
                    uploadedAvatar.src = "{{ $akuntan->foto_diri ? Storage::url($akuntan->foto_diri) : asset('admin/assets/img/avatars/1.png') }}";
                };
            }
            ...
            const currentProv = "{{ old('province_code', $akuntan->province_code) }}";
            const currentReg  = "{{ old('regency_code', $akuntan->regency_code) }}";
            const currentDist = "{{ old('district_code', $akuntan->district_code) }}";
            const currentVill = "{{ old('village_code', $akuntan->village_code) }}";
