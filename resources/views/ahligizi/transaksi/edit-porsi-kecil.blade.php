            ...
            <div class="col-12">
                <div class="alert alert-warning d-flex align-items-center" role="alert">
                    ...
                    <div>
                        ...
                        <span class="badge bg-warning text-dark ms-2">{{ formatIndonesianNumber($totalPorsiPenerima) }} Porsi</span>
                                ...
                                <div class="row align-items-end">
                                    <div class="col-md-4">
                                        <div class="d-flex align-items-center mb-2">
                                            <label class="form-label fw-semibold mb-0">Jumlah Porsi Kecil</label>
                                            @if($totalPorsiPenerima > 0)
                                                <button type="button" class="btn btn-link p-0 ms-2 text-warning" data-bs-toggle="modal" data-bs-target="#detailPenerimaModal" title="Detail Penerima">
                                ...
                                <tbody>
                                    @foreach($detailPenerima as $penerima)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-label-warning text-dark">{{ formatIndonesianNumber($penerima->jumlah_porsi) }} Porsi</span>
                                            </td>
                                            <td>
                                                @if($penerima->link_gmaps)
                                                    <a href="{{ $penerima->link_gmaps }}" target="_blank" class="btn btn-sm btn-outline-warning">
            ...
            if (menus.length === 0) {
                menuList.html(`
                    <div class="col-12 text-center py-4">
                        <div class="avatar avatar-lg mx-auto mb-3">
                            <span class="avatar-initial rounded bg-label-secondary"><i class="bx bx-bowl-hot"></i></span>
                        </div>
