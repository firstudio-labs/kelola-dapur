            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="mb-1">Dashboard Ahli Gizi</h4>
                            <p class="mb-0 text-muted">
                                <i class="bx bx-user me-1"></i>
                                {{ $user->nama ?? 'N/A' }} (Ahli Gizi)
                            </p>
                            <p class="mb-0 text-muted">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">Ahli Gizi</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{ $dapur->telepon ?? 'N/A' }}</dd>
                        <dt class="col-sm-4">Status</dt>
                        <dd class="col-sm-8">
                            <span
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted mb-4">
                        Anda belum membuat menu makanan. Mulai dengan membuat
                        menu pertama Anda.
                    </p>
                    @if(isset($dapur->id_dapur))
                    <a
                    ...
                    >
                        <i class="bx bx-plus me-1"></i> Buat Menu Pertama
                    </a>
                    @else
                    <a
                        href="{{ route('ahli-gizi.menu-makanan.create') }}"
