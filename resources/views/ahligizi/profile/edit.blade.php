        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ahli-gizi.profile.security.edit', $dapur) }}">
                ...
                <div class="card mb-4">
                    ...
                    <form id="formAccountSettings" method="POST" action="{{ route('ahli-gizi.profile.update', $dapur) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <hr class="my-3">
                                    <h6 class="fw-semibold mb-3">Detail Personal Ahli Gizi</h6>
                                    ...
                                    <div class="d-flex align-items-start align-items-sm-center justify-content-center gap-4 mb-4">
                                        <div class="position-relative">
                                            <img id="uploadedAvatar"
                                                src="{{ $ahliGizi->foto_diri ? Storage::url($ahliGizi->foto_diri) : asset('admin/assets/img/avatars/1.png') }}"
                                        ...
                                        <div class="button-wrapper text-start">
                                            <button type="button"
                                                class="btn btn-outline-secondary btn-sm mb-2 account-image-reset {{ !$ahliGizi->foto_diri ? 'd-none' : '' }}">
                                    ...
                                    <div class="row g-4">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nik_ahli_gizi" name="nik_ahli_gizi"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control @error('nama_lengkap') is-invalid @enderror" type="text"
                                                name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap', $ahliGizi->nama_lengkap) }}"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select name="pendidikan_terakhir" id="pendidikan_terakhir"
                                                ...
                                                @foreach (['SD', 'SMP', 'SMA', 'D1', 'D2', 'D3', 'Sarjana'] as $edu)
                                                    <option value="{{ $edu }}"
                                                        {{ old('pendidikan_terakhir', $ahliGizi->pendidikan_terakhir) === $edu ? 'selected' : '' }}>
                                                        {{ $edu }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="hidden" name="provinsi" id="province_name"
                                        value="{{ old('provinsi', $ahliGizi->province_name) }}">
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="hidden" name="kabupaten_kota" id="regency_name"
                                        value="{{ old('kabupaten_kota', $ahliGizi->regency_name) }}">
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="hidden" name="kecamatan" id="district_name"
                                        value="{{ old('kecamatan', $ahliGizi->district_name) }}">
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="hidden" name="kelurahan" id="village_name"
                                        value="{{ old('kelurahan', $ahliGizi->village_name) }}">
                                </div>
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea class="form-control @error('alamat_detail') is-invalid @enderror" id="alamat_detail"
                                        name="alamat_detail" rows="3" placeholder="Nama jalan, gedung, no rumah, RT/RW, dsb.">{{ old('alamat_detail', $ahliGizi->alamat_detail) }}</textarea>
                                    @error('alamat_detail')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mt-2 text-end">
                                ...
                                <a href="{{ route('ahli-gizi.dashboard') }}" class="btn btn-outline-secondary">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (accountImageReset) {
                accountImageReset.onclick = () => {
                    uploadInput.value = '';
                    uploadedAvatar.src =
                        "{{ $ahliGizi->foto_diri ? Storage::url($ahliGizi->foto_diri) : asset('admin/assets/img/avatars/1.png') }}";
                };
            }
            ...
            const currentProv = "{{ old('province_code', $ahliGizi->province_code) }}";
            const currentReg  = "{{ old('regency_code', $ahliGizi->regency_code) }}";
            const currentDist = "{{ old('district_code', $ahliGizi->district_code) }}";
            const currentVill = "{{ old('village_code', $ahliGizi->village_code) }}";
